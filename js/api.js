...
import {
   ...
   */
  export function calcularPrecio(coinPrice, disponibilidad, factorClima = 1.0) {
    // Aseguramos que el precio base sea al menos 0.5 para evitar precios de 0.00
    const precioBase = Math.max(coinPrice * PRICE_FACTOR, 0.5)
    ...
    const precioFinal = precioBase * factorDisponibilidad * factorClima
